...
//        let result = await GoogleSyncViewModel.shared.checkForGmailSync(email: email)
...
//        }
    ...
    func enableGmailSync() async {
        let result = await GoogleSyncViewModel.shared.enableGmailSync(authorizationCode: nil, email: email)
    ...
    func checkForCalendarSync() async {
        let result = await GoogleSyncViewModel.shared.checkForCalendarSync()
